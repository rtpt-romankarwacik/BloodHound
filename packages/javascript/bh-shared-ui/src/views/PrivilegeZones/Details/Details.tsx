...
import { detailsPath, membersPath, privilegeZonesPath, rulesPath } from '../../../routes';
                ...
                <div className='flex basis-2/3 bg-neutral-2 min-w-0 rounded-lg shadow-outer-1 h-fit'>
                    ...
                    {selectorId !== undefined ? (
                        <MembersList
                            ...
                            onClick={(id) => {
                                navigate(
                                    `/${privilegeZonesPath}/${tagType}/${tagId}/${rulesPath}/${selectorId}/${membersPath}/${id}/${detailsPath}`
                                );
                            }}
